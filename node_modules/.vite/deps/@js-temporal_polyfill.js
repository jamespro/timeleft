...
var JSBI = class _JSBI extends Array {
  constructor(i2, _2) {
    if (super(i2), this.sign = _2, Object.setPrototypeOf(this, _JSBI.prototype), i2 > _JSBI.__kMaxLength)
  ...
  static BigInt(i2) {
    ...
    if ("number" == typeof i2) {
      if (0 === i2)
        return _JSBI.__zero();
      if (_JSBI.__isOneDigitInt(i2))
        return 0 > i2 ? _JSBI.__oneDigit(-i2, true) : _JSBI.__oneDigit(i2, false);
      if (!t2(i2) || _2(i2) !== i2)
    ...
    if ("boolean" == typeof i2)
      return true === i2 ? _JSBI.__oneDigit(1, false) : _JSBI.__zero();
    if ("object" == typeof i2) {
      if (i2.constructor === _JSBI)
        return i2;
  ...
  static exponentiate(i2, _2) {
    ...
    if (1 === i2.length && 1 === i2.__digit(0))
      return i2.sign && 0 == (1 & _2.__digit(0)) ? _JSBI.unaryMinus(i2) : i2;
    if (1 < _2.length)
      throw new RangeError("BigInt too big");
    let t2 = _2.__unsignedDigit(0);
    if (1 === t2)
      return i2;
    if (t2 >= _JSBI.__kMaxLengthBits)
      throw new RangeError("BigInt too big");
    ...
    for (0 != (1 & t2) && (e = i2), t2 >>= 1; 0 !== t2; t2 >>= 1)
      n2 = _JSBI.multiply(n2, n2), 0 != (1 & t2) && (null === e ? e = n2 : e = _JSBI.multiply(e, n2));
    return e;
  }
  static multiply(_2, t2) {
    ...
    for (let n2 = 0; n2 < _2.length; n2++)
      _JSBI.__multiplyAccumulate(t2, _2.__digit(n2), e, n2);
    return e.__trim();
  }
  static divide(i2, _2) {
    if (0 === _2.length)
      throw new RangeError("Division by zero");
    if (0 > _JSBI.__absoluteCompare(i2, _2))
      return _JSBI.__zero();
    const t2 = i2.sign !== _2.sign, e = _2.__unsignedDigit(0);
    let n2;
    if (1 === _2.length && 32767 >= e) {
      if (1 === e)
        return t2 === i2.sign ? i2 : _JSBI.unaryMinus(i2);
      n2 = _JSBI.__absoluteDivSmall(i2, e, null);
    } else
      n2 = _JSBI.__absoluteDivLarge(i2, _2, true, false);
  ...
  static equal(_2, t2) {
    ...
    if (_2.length !== t2.length)
      return false;
    for (let e = 0; e < _2.length; e++)
      if (_2.__digit(e) !== t2.__digit(e))
        return false;
    return true;
  }
  ...
  static bitwiseAnd(i2, _2) {
    var t2 = Math.max;
    if (!i2.sign && !_2.sign)
      return _JSBI.__absoluteAnd(i2, _2).__trim();
    if (i2.sign && _2.sign) {
  ...
  static bitwiseXor(i2, _2) {
    var t2 = Math.max;
    if (!i2.sign && !_2.sign)
      return _JSBI.__absoluteXor(i2, _2).__trim();
    if (i2.sign && _2.sign) {
  ...
  static bitwiseOr(i2, _2) {
    ...
    if (!i2.sign && !_2.sign)
      return _JSBI.__absoluteOr(i2, _2).__trim();
    if (i2.sign && _2.sign) {
  ...
  static asIntN(_2, t2) {
    ...
    if (0 === _2)
      return _JSBI.__zero();
    if (_2 >= _JSBI.__kMaxLengthBits)
      return t2;
    const e = 0 | (_2 + 29) / 30;
    if (t2.length < e)
      return t2;
    const g2 = t2.__unsignedDigit(e - 1), s2 = 1 << (_2 - 1) % 30;
    if (t2.length === e && g2 < s2)
      return t2;
    if (!((g2 & s2) === s2))
      return _JSBI.__truncateToNBits(_2, t2);
    if (!t2.sign)
      return _JSBI.__truncateAndSubFromPowerOfTwo(_2, t2, true);
    if (0 == (g2 & s2 - 1)) {
  ...
  static ADD(i2, _2) {
    if (i2 = _JSBI.__toPrimitive(i2), _2 = _JSBI.__toPrimitive(_2), "string" == typeof i2)
      return "string" != typeof _2 && (_2 = _2.toString()), i2 + _2;
    if ("string" == typeof _2)
      return i2.toString() + _2;
    if (i2 = _JSBI.__toNumeric(i2), _2 = _JSBI.__toNumeric(_2), _JSBI.__isBigInt(i2) && _JSBI.__isBigInt(_2))
      return _JSBI.add(i2, _2);
  ...
  static EQ(i2, _2) {
    for (; ; ) {
      if (_JSBI.__isBigInt(i2))
        return _JSBI.__isBigInt(_2) ? _JSBI.equal(i2, _2) : _JSBI.EQ(_2, i2);
      if ("number" == typeof i2) {
        if (_JSBI.__isBigInt(_2))
          return _JSBI.__equalToNumber(_2, i2);
        if ("object" != typeof _2)
          return i2 == _2;
        _2 = _JSBI.__toPrimitive(_2);
      } else if ("string" == typeof i2) {
        if (_JSBI.__isBigInt(_2))
          return i2 = _JSBI.__fromString(i2), null !== i2 && _JSBI.equal(i2, _2);
        if ("object" != typeof _2)
          return i2 == _2;
        _2 = _JSBI.__toPrimitive(_2);
        ...
        if ("object" == typeof _2 && _2.constructor !== _JSBI)
          return i2 == _2;
  ...
  static __fromString(i2, _2 = 0) {
    ...
    if (n2 !== e) {
      if (!_JSBI.__isWhitespace(g2))
        return null;
      for (n2++; n2 < e; n2++)
        if (g2 = i2.charCodeAt(n2), !_JSBI.__isWhitespace(g2))
          return null;
    }
  ...
  static __toStringBasePowerOfTwo(_2, i2) {
    ...
    for (let e2 = 0; e2 < t2 - 1; e2++) {
      ...
      for (u2 = i3 >>> s3, d2 = 30 - s3; d2 >= n2; )
        r2[a2--] = _JSBI.__kConversionChars[u2 & g2], u2 >>>= n2, d2 -= n2;
    }
    const h2 = (u2 | s2 << d2) & g2;
    for (r2[a2--] = _JSBI.__kConversionChars[h2], u2 = s2 >>> n2 - d2; 0 !== u2; )
      r2[a2--] = _JSBI.__kConversionChars[u2 & g2], u2 >>>= n2;
  ...
  static __compareToNumber(i2, _2) {
    if (_JSBI.__isOneDigitInt(_2)) {
      ...
      if (1 < i2.length)
        return _JSBI.__absoluteGreater(t2);
  ...
  static __compare(i2, _2, t2) {
    if (i2 = _JSBI.__toPrimitive(i2), _2 = _JSBI.__toPrimitive(_2), "string" == typeof i2 && "string" == typeof _2)
      switch (t2) {
        case 0:
          return i2 < _2;
        case 1:
    ...
    if (_JSBI.__isBigInt(i2) && "string" == typeof _2)
      return _2 = _JSBI.__fromString(_2), null !== _2 && _JSBI.__comparisonResultToBool(_JSBI.__compareToBigInt(i2, _2), t2);
    if ("string" == typeof i2 && _JSBI.__isBigInt(_2))
      return i2 = _JSBI.__fromString(i2), null !== i2 && _JSBI.__comparisonResultToBool(_JSBI.__compareToBigInt(i2, _2), t2);
    if (i2 = _JSBI.__toNumeric(i2), _2 = _JSBI.__toNumeric(_2), _JSBI.__isBigInt(i2)) {
      if (_JSBI.__isBigInt(_2))
        return _JSBI.__comparisonResultToBool(_JSBI.__compareToBigInt(i2, _2), t2);
      if ("number" != typeof _2)
        throw new Error("implementation bug");
    ...
    if ("number" != typeof i2)
      throw new Error("implementation bug");
    if (_JSBI.__isBigInt(_2))
      return _JSBI.__comparisonResultToBool(_JSBI.__compareToNumber(_2, i2), 2 ^ t2);
    if ("number" != typeof _2)
      throw new Error("implementation bug");
  ...
  static __absoluteAdd(_2, t2, e) {
    if (_2.length < t2.length)
      return _JSBI.__absoluteAdd(t2, _2, e);
    if (0 === _2.length)
      return _2;
    if (0 === t2.length)
      return _2.sign === e ? _2 : _JSBI.unaryMinus(_2);
    let n2 = _2.length;
  ...
  static __absoluteAnd(_2, t2, e = null) {
    ...
    let l2 = 0;
    for (; l2 < s2; l2++)
      e.__setDigit(l2, _2.__digit(l2) & t2.__digit(l2));
    for (; l2 < o2; l2++)
      e.__setDigit(l2, 0);
    return e;
  }
  ...
  static __leftShiftByAbsolute(_2, i2) {
    ...
    if (0 === n2) {
      ...
      for (; t3 < e; t3++)
        l2.__setDigit(t3, 0);
      for (; t3 < o2; t3++)
        l2.__setDigit(t3, _2.__digit(t3 - e));
    } else {
      let t3 = 0;
      for (let _3 = 0; _3 < e; _3++)
        l2.__setDigit(_3, 0);
  ...
  static __rightShiftByAbsolute(_2, i2) {
    ...
    if (0 === s2) {
      ...
      for (let e2 = g2; e2 < t2; e2++)
        r2.__setDigit(e2 - g2, _2.__digit(e2));
    } else {
...
function DefineIntrinsic(e, r2) {
  const o2 = `%${e}%`;
  if (void 0 !== t[o2])
    throw new Error(`intrinsic ${e} already exists`);
  t[o2] = r2;
}
...
function ToIntegerIfIntegral(e) {
  ...
  if (!IsIntegralNumber(t2))
    throw new RangeError(`unsupported fractional value ${e}`);
  return 0 === t2 ? 0 : t2;
}
...
function ToObject(e) {
  if (null == e)
    throw new TypeError(`Expected object not ${e}`);
  return Object(e);
}
function CopyDataProperties(e, t2, r2, o2) {
  ...
  const n2 = ye(t2);
  for (const a2 of n2)
    if (!r2.some((e2) => Object.is(e2, a2)) && Object.prototype.propertyIsEnumerable.call(t2, a2)) {
      const r3 = t2[a2];
      if (o2 && o2.some((e2) => Object.is(e2, r3)))
        continue;
      e[a2] = r3;
    }
}
...
function ParseTemporalTimeZone(e) {
  const { ianaName: t2, offset: r2, z: o2 } = function ParseTemporalTimeZoneString(e2) {
    if (new RegExp(`^${$.source}$`, "i").test(e2))
      return { ianaName: e2 };
    try {
...
function ParseISODateTime(e) {
  const t2 = V.exec(e);
  if (!t2)
    throw new RangeError(`invalid ISO 8601 string: ${e}`);
  let r2 = t2[1];
  ...
  let I2;
  for (const [, e2, t3, r3] of y2.matchAll(H))
    if ("u-ca" === t3)
      void 0 === I2 && (I2 = r3);
    else if ("!" === e2)
...
function ParseTemporalYearMonthString(e) {
  ...
  if (t2) {
    ...
    const i2 = t2[3];
    for (const [, e2, t3, r3] of i2.matchAll(H))
      if ("u-ca" === t3)
        void 0 === n2 && (n2 = r3);
      else if ("!" === e2)
        throw new RangeError(`Unrecognized annotation: !${t3}=${r3}`);
    ...
    let t3;
    if ({ year: r2, month: o2, calendar: n2, day: a2, z: t3 } = ParseISODateTime(e), t3)
...
function ParseTemporalMonthDayString(e) {
  ...
  if (t2) {
    ...
    const e2 = t2[3];
    for (const [, t3, r3, o3] of e2.matchAll(H))
      if ("u-ca" === r3)
        void 0 === n2 && (n2 = o3);
      else if ("!" === t3)
    ...
    let t3;
    if ({ month: r2, day: o2, calendar: n2, year: a2, z: t3 } = ParseISODateTime(e), t3)
...
function ToTemporalDurationRecord(e) {
  if (!IsObject(e))
    return function ParseTemporalDurationString(e2) {
      const t3 = Q.exec(e2);
      if (!t3)
        throw new RangeError(`invalid duration: ${e2}`);
      if (t3.slice(2).every((e3) => void 0 === e3))
        throw new RangeError(`invalid duration: ${e2}`);
  ...
  if (IsTemporalDuration(e))
    return { years: GetSlot(e, w), months: GetSlot(e, D), weeks: GetSlot(e, G), days: GetSlot(e, v), hours: GetSlot(e, C), minutes: GetSlot(e, O), seconds: GetSlot(e, b), milliseconds: GetSlot(e, E), microseconds: GetSlot(e, M), nanoseconds: GetSlot(e, R) };
...
function ValidateTemporalRoundingIncrement(e, t2, r2) {
  const o2 = r2 ? t2 : t2 - 1;
  if (e > o2)
    throw new RangeError(`roundingIncrement must be at least 1 and less than ${o2}, not ${e}`);
  if (t2 % e != 0)
...
function GetTemporalUnit(e, t2, r2, o2, n2 = []) {
  const a2 = [];
  for (const [, e2, t3] of Ue)
    "datetime" !== r2 && r2 !== t3 || a2.push(e2);
  a2.push(...n2);
  let i2 = o2;
...
function ToRelativeTemporalObject(e) {
  ...
  if (IsObject(t2)) {
    ...
    let e2, f2;
    if ({ year: r2, month: o2, day: n2, hour: a2, minute: i2, second: s2, millisecond: l2, microsecond: d2, nanosecond: m2, calendar: c2, ianaName: e2, offset: u2, z: f2 } = ParseISODateTime(ToString(t2)), e2)
      h2 = ToTemporalTimeZoneSlotValue(e2), f2 ? T2 = "exact" : u2 || (T2 = "wall"), p2 = true;
    else if (f2)
...
function DefaultTemporalLargestUnit(e, t2, r2, o2, n2, a2, i2, s2, l2, d2) {
  for (const [m2, c2] of [["years", e], ["months", t2], ["weeks", r2], ["days", o2], ["hours", n2], ["minutes", a2], ["seconds", i2], ["milliseconds", s2], ["microseconds", l2], ["nanoseconds", d2]])
    if (0 !== c2)
      return Ae.get(m2);
  return "nanosecond";
}
...
function ToTemporalDateTime(e, t2) {
  ...
  if (IsObject(e)) {
    ...
    if (IsTemporalZonedDateTime(e))
      return ToTemporalOverflow(t2), GetPlainDateTimeFor(GetSlot(e, g), GetSlot(e, S), GetSlot(e, p));
    if (IsTemporalDate(e))
      return ToTemporalOverflow(t2), CreateTemporalDateTime(GetSlot(e, i), GetSlot(e, s), GetSlot(e, l), 0, 0, 0, 0, 0, 0, GetSlot(e, p));
...
function ToTemporalTime(e, t2 = "constrain") {
  ...
  if (IsObject(l2)) {
    ...
    ({ hour: r2, minute: o2, second: n2, millisecond: a2, microsecond: i2, nanosecond: s2 } = function ParseTemporalTimeString(e2) {
      const t3 = z.exec(e2);
      ...
      if (t3) {
        ...
        for (const [, e4, t4, r4] of l3.matchAll(H))
          if ("u-ca" !== t4 && "!" === e4)
        ...
        let t4, l4;
        if ({ hasTime: l4, hour: r3, minute: o3, second: n3, millisecond: a3, microsecond: i3, nanosecond: s3, z: t4 } = ParseISODateTime(e2), !l4)
          throw new RangeError(`time is missing in string: ${e2}`);
        if (t4)
          throw new RangeError("Z designator not supported for PlainTime");
      }
      if (/[tT ][0-9][0-9]/.test(e2))
...
function ToTemporalZonedDateTime(e, t2) {
  ...
  if (IsObject(e)) {
    ...
    if ({ year: r2, month: o2, day: n2, hour: a2, minute: i2, second: s2, millisecond: l2, microsecond: d2, nanosecond: m2, ianaName: I3, offset: h2, z: S2, calendar: u2 } = function ParseTemporalZonedDateTimeString(e2) {
      ...
      return t3;
    }(ToString(e)), c2 = ToTemporalTimeZoneSlotValue(I3), S2 ? y2 = "exact" : h2 || (y2 = "wall"), u2 || (u2 = "iso8601"), !IsBuiltinCalendar(u2))
...
function ParseTimeZoneOffsetString(e) {
  ...
  if (!t2)
    throw new RangeError(`invalid time zone offset: ${e}`);
...
function GetNamedTimeZoneDateTimeParts(e, t2) {
  const { epochMilliseconds: r2, millisecond: o2, microsecond: n2, nanosecond: a2 } = GetISOPartsFromEpoch(t2), { year: i2, month: s2, day: l2, hour: d2, minute: m2, second: c2 } = function GetFormatterParts(e2, t3) {
    ...
    return function parseFromEnUsFormat(e3) {
      const t4 = e3.split(/[^\w]+/);
      if (7 !== t4.length)
        throw new RangeError(`expected 7 parts in "${e3}`);
      ...
      if ("B" === a3 || "BC" === a3)
        ...
        throw new RangeError(`Unknown era ${a3} in "${e3}`);
      let i3 = +t4[4];
      24 === i3 && (i3 = 0);
      const s3 = +t4[5], l3 = +t4[6];
      if (!(me(n3) && me(r4) && me(o3) && me(i3) && me(s3) && me(l3)))
        throw new RangeError(`Invalid number in "${e3}`);
...
function GetNamedTimeZoneNextTransition(t2, r2) {
  if (jsbi_default.lessThan(r2, Pe))
  ...
  for (; i2 === l2 && jsbi_default.lessThan(jsbi_default.BigInt(a2), n2); ) {
    if (s2 = jsbi_default.add(a2, Ne), jsbi_default.greaterThan(s2, Re))
      return null;
...
function DurationSign(e, t2, r2, o2, n2, a2, i2, s2, l2, d2) {
  for (const m2 of [e, t2, r2, o2, n2, a2, i2, s2, l2, d2])
    if (0 !== m2)
      return m2 < 0 ? -1 : 1;
  return 0;
}
...
function NanosecondsToDays(t2, r2) {
  ...
  if (1 === a2)
    for (; jsbi_default.greaterThan(R2, Ie) && jsbi_default.greaterThan(M2, D2); )
      R2 = jsbi_default.subtract(R2, Se), M2 = AddZonedDateTime(w2, v2, C2, 0, 0, 0, jsbi_default.toNumber(R2), 0, 0, 0, 0, 0, 0);
  ...
  if (jsbi_default.greaterThanOrEqual(abs(f2), abs(jsbi_default.BigInt(y2))))
    throw new Error("assert not reached");
...
function BalancePossiblyInfiniteDuration(t2, r2, o2, a2, i2, s2, l2, d2, m2) {
  ...
  for (const e of [I2, D2, G2, v2, C2, O2, b2])
    if (!me(e))
...
function RejectToRange(e, t2, r2) {
  if (e < t2 || e > r2)
    throw new RangeError(`value out of range: ${t2} <= ${e} <= ${r2}`);
}
...
function RejectDateTimeRange(e, t2, r2, o2, n2, a2, i2, s2, l2) {
  if (RejectToRange(e, Fe, Ye), e === Fe && null == GetUTCEpochNanoseconds(e, t2, r2 + 1, o2, n2, a2, i2, s2, l2 - 1) || e === Ye && null == GetUTCEpochNanoseconds(e, t2, r2 - 1, o2, n2, a2, i2, s2, l2 + 1))
    throw new RangeError("DateTime outside of supported range");
}
function ValidateEpochNanoseconds(t2) {
  if (jsbi_default.lessThan(t2, Me) || jsbi_default.greaterThan(t2, Re))
...
function DifferenceISODate(e, t2, r2, o2, n2, a2, i2) {
  switch (i2) {
    ...
    case "month": {
      ...
      if (h2 !== s2 && (m2 -= s2, u2 += 12 * s2), c2 = AddISODate(e, t2, r2, m2, u2, 0, 0, "constrain"), h2 = -CompareISODate(c2.year, c2.month, c2.day, o2, n2, a2), 0 === h2)
    ...
    case "day": {
      ...
      for (let e2 = l2.year; e2 < s2.year; ++e2)
        m2 += LeapYear(e2) ? 366 : 365;
      let c2 = 0;
...
function DifferenceTemporalZonedDateTime(e, t2, r2, o2) {
  ...
  if ("year" !== d2.largestUnit && "month" !== d2.largestUnit && "week" !== d2.largestUnit && "day" !== d2.largestUnit)
    ...
    if (!TimeZoneEquals(e2, GetSlot(i2, g)))
...
function AddZonedDateTime(e, t2, r2, o2, a2, p2, f2, y2, I2, S2, g2, w2, D2, G2) {
  ...
  if (0 === DurationSign(o2, a2, p2, f2, 0, 0, 0, 0, 0, 0))
    return AddInstant(GetSlot(e, n), y2, I2, S2, g2, w2, D2);
...
function RoundNumberToIncrement(t2, r2, o2) {
  if (jsbi_default.equal(r2, Se))
    return t2;
  let { quotient: n2, remainder: a2 } = divmod(t2, r2);
  if (jsbi_default.equal(a2, Ie))
    return t2;
...
function CompareISODate(e, t2, r2, o2, n2, a2) {
  for (const [i2, s2] of [[e, o2], [t2, n2], [r2, a2]])
    if (i2 !== s2)
...
function amend(e = {}, t2 = {}) {
  const r2 = lt({}, e);
  for (const e2 of ["year", "month", "day", "hour", "minute", "second", "weekday", "dayPeriod", "timeZoneName", "dateStyle", "timeStyle"])
    r2[e2] = e2 in t2 ? t2[e2] : r2[e2], false !== r2[e2] && void 0 !== r2[e2] || delete r2[e2];
  return r2;
}
...
function monthCodeNumberPart(e) {
  if (!e.startsWith("M"))
    throw new RangeError(`Invalid month code: ${e}.  Month codes must start with M.`);
  const t2 = +e.slice(1);
  if (isNaN(t2))
    throw new RangeError(`Invalid month code: ${e}`);
  return t2;
}
...
var OneObjectCache = class _OneObjectCache {
  ...
  setObject(e) {
    if (_OneObjectCache.objectMap.get(e))
  ...
  isoToCalendarDate(e, t2) {
    ...
    for (let { type: e2, value: t3 } of l2) {
      if ("year" === e2 && (m2.eraYear = +t3), "relatedYear" === e2 && (m2.eraYear = +t3), "month" === e2) {
        ...
        if (!e3 || 3 != e3.length || !e3[1] && !e3[2])
          throw new RangeError(`Unexpected month: ${t3}`);
        if (m2.month = e3[1] ? +e3[1] : 1, m2.month < 1)
...
var GregorianBaseHelper = class extends HelperBase {
  constructor(e, t2) {
    ...
    const { eras: r2, anchorEra: o2 } = function adjustEras(e2) {
      ...
      if (r3.filter((e3) => null != e3.reverseOf).length > 1)
    ...
    const checkField = (t3, r3) => {
      ...
      const o3 = { ...e, year: t3 }, n2 = this.eras.find((e2, n3) => {
        if (n3 === this.eras.length - 1) {
          if (e2.reverseOf) {
            if (t3 > 0)
              throw new RangeError(`Signed year ${t3} is invalid for era ${e2.name}`);
...
var PlainDate = class _PlainDate {
  ...
  equals(e) {
    ...
    for (const e2 of [i, s, l]) {
      if (GetSlot(this, e2) !== GetSlot(t2, e2))
        return false;
    }
  ...
  toZonedDateTime(e) {
    ...
    if (IsObject(e))
      ...
      t2 = ToTemporalTimeZoneSlotValue(e);
    ...
    return void 0 !== Y2 && ValidateTemporalRoundingIncrement(y2, Y2, false), { years: r2, months: o2, weeks: n2, days: a2 } = UnbalanceDurationRelative(r2, o2, n2, a2, T2, f2), { years: r2, months: o2, weeks: n2, days: a2, hours: i2, minutes: s2, seconds: l2, milliseconds: d2, microseconds: m2, nanoseconds: c2 } = RoundDuration(r2, o2, n2, a2, i2, s2, l2, d2, m2, c2, y2, S2, I2, f2), { years: r2, months: o2, weeks: n2, days: a2, hours: i2, minutes: s2, seconds: l2, milliseconds: d2, microseconds: m2, nanoseconds: c2 } = AdjustRoundedDurationDays(r2, o2, n2, a2, i2, s2, l2, d2, m2, c2, y2, S2, I2, f2), { days: a2, hours: i2, minutes: s2, seconds: l2, milliseconds: d2, microseconds: m2, nanoseconds: c2 } = BalanceDuration(a2, i2, s2, l2, d2, m2, c2, T2, f2), { years: r2, months: o2, weeks: n2, days: a2 } = function BalanceDurationRelative(t3, r3, o3, n3, a3, i3) {
      ...
      switch (a3) {
        case "year": {
          ...
          let r4, o4, n4;
          for ({ relativeTo: r4, days: o4 } = MoveRelativeDate(m3, c3, y3, t4); jsbi_default.greaterThanOrEqual(abs(f3), jsbi_default.BigInt(ae(o4))); )
            f3 = jsbi_default.subtract(f3, jsbi_default.BigInt(o4)), h3 = jsbi_default.add(h3, d3), c3 = r4, { relativeTo: r4, days: o4 } = MoveRelativeDate(m3, c3, y3, t4);
          for ({ relativeTo: r4, days: n4 } = MoveRelativeDate(m3, c3, I3, t4); jsbi_default.greaterThanOrEqual(abs(f3), jsbi_default.BigInt(ae(n4))); )
            f3 = jsbi_default.subtract(f3, jsbi_default.BigInt(n4)), u3 = jsbi_default.add(u3, d3), c3 = r4, { relativeTo: r4, days: n4 } = MoveRelativeDate(m3, c3, I3, t4);
        ...
        case "month": {
          ...
          const t4 = "string" != typeof m3 ? GetMethod(m3, "dateAdd") : void 0;
          let r4, o4;
          for ({ relativeTo: r4, days: o4 } = MoveRelativeDate(m3, c3, I3, t4); jsbi_default.greaterThanOrEqual(abs(f3), jsbi_default.BigInt(ae(o4))); )
            f3 = jsbi_default.subtract(f3, jsbi_default.BigInt(o4)), u3 = jsbi_default.add(u3, d3), c3 = r4, { relativeTo: r4, days: o4 } = MoveRelativeDate(m3, c3, I3, t4);
          break;
        }
        case "week": {
          if (!m3)
          ...
          const t4 = "string" != typeof m3 ? GetMethod(m3, "dateAdd") : void 0;
          let r4, o4;
          for ({ relativeTo: r4, days: o4 } = MoveRelativeDate(m3, c3, S3, t4); jsbi_default.greaterThanOrEqual(abs(f3), jsbi_default.BigInt(ae(o4))); )
            f3 = jsbi_default.subtract(f3, jsbi_default.BigInt(o4)), T3 = jsbi_default.add(T3, d3), c3 = r4, { relativeTo: r4, days: o4 } = MoveRelativeDate(m3, c3, S3, t4);
          break;
        }
      }
...
var ZonedDateTime = class {
  ...
  round(t2) {
    ...
    if (jsbi_default.lessThanOrEqual(B2, Ie))
